    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php
                ...
                $no=0; //join digunakan untuk menggabungkan 2 database
            ...
            <tr> 
                ...
                <td>
                <a href="ubah_siswa.php?id_siswa=
                    <?=$data_siswa ['id_siswa']?>" class="btn btn-success">Edit</a>
                    <a href="hapus_siswa.php?id_siswa=
                    <?=$data_siswa ['id_siswa']?>" class="btn btn-danger"
