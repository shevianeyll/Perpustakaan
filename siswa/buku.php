<?php
    include "header.php";
?>
<h2 align="center">Daftar Buku Perpustakaan</h2>
<div class="row">
    <?php
        include "../koneksi.php";
        $qry_buku=mysqli_query($conn,"select * from buku"); //menampilkan / print database
        while($dt_buku=mysqli_fetch_array($qry_buku)){ //fetcharray digunakan mengambil data berupa array
    ?>
    <div class="col-md-3">
        <div class="card" >
